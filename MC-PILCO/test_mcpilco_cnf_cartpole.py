...
flows_learning_par['device'] = device
flows_learning_par['dtype'] = dtype
...
MC_PILCO_CNF_init_dict = {}
MC_PILCO_CNF_init_dict['T_sampling'] = T_sampling
MC_PILCO_CNF_init_dict['state_dim'] = state_dim
MC_PILCO_CNF_init_dict['input_dim'] = input_dim
MC_PILCO_CNF_init_dict['f_sim'] = ode_fun
MC_PILCO_CNF_init_dict['std_meas_noise'] = np.array(std_list)
...
MC_PILCO_CNF_init_dict['f_rand_exploration_policy'] = f_rand_exploration_policy # Exploration policy function
MC_PILCO_CNF_init_dict['rand_exploration_policy_par'] = rand_exploration_policy_par # Exploration policy function parameters
MC_PILCO_CNF_init_dict['f_control_policy'] = f_control_policy # Control policy function
MC_PILCO_CNF_init_dict['control_policy_par'] = control_policy_par # Control policy function parameters
MC_PILCO_CNF_init_dict['f_cost_function'] = f_cost_function # Cost function
MC_PILCO_CNF_init_dict['cost_function_par'] = cost_function_par # Cost function parameters
MC_PILCO_CNF_init_dict['log_path'] = 'results_tmp/'+str(seed) # path to save logs of the experiments
MC_PILCO_CNF_init_dict['dtype'] = dtype
MC_PILCO_CNF_init_dict['device'] = device
PL_obj = MC_PILCO.MC_PILCO_CNF(**MC_PILCO_CNF_init_dict) # Main object of the algorithm with MC-PILCO properties
...
config_log_dict['MC_PILCO_CNF_init_dict'] = MC_PILCO_CNF_init_dict

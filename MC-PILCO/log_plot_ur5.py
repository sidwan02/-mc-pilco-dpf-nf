...
for trial_index in range(0,num_trials):
    ...
    theta1, theta2, theta3, theta4, theta5, theta6 = \
            state_samples[:,:,:1], state_samples[:,:,1:2], state_samples[:,:,2:3], state_samples[:,:,3:4], state_samples[:,:,4:5], state_samples[:,:,5:6]
...
for trial_index in range(0,num_trials+1):
    ...
    dot_theta1, dot_theta2, dot_theta3, dot_theta4, dot_theta5, dot_theta6 = \
            state_samples[:,6:7], state_samples[:,7:8], state_samples[:,8:9], state_samples[:,9:10], state_samples[:,10:11], state_samples[:,11:12]
